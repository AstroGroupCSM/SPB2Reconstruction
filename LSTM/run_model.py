...
if __name__ == '__main__':
    ...
    parser.add_argument('--conv_kernel_size', default=6, type=int)
    parser.add_argument('--conv_stride', default=1, type=int)
    parser.add_argument('--pool_kernel_size', default=6, type=int)
    ...
    parser.add_argument('--rnn_input_dropout_prob', default=0.35, type=float)
    parser.add_argument('--rnn_output_dropout_prob', default=0.35, type=float)

    parser.add_argument('--linear_projection_dropout_prob', default=0.3, type=float)
    ...
    parser.add_argument('--n_data_workers', default=1, help='# threads used to fetch data')
